...
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("Big Arm pos", drive.leftBigArm.getCurrentPosition());
            telemetry.addData("Small Arm pos", drive.smallArm.getCurrentPosition());

            drive.leftBigArm.setPower(gamepad2.left_stick_y/ 2);
            drive.rightBigArm.setPower(gamepad2.left_stick_y / 2);
            drive.smallArm.setPower(gamepad2.right_stick_y / 2);
