...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2151.6497316532927; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1990.7692403222081; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2338.087460578252; // x position of the perpendicular encoder (in tick units)
    }
